...
export const login: LoginDict = {
  ...
  faleComAgencia: "Contacta a tu agencia para renovar o reactivar el acceso.",
  definirSenhaTitulo: "Bienvenido(a)",
  ...
  mostrarSenhaAria: "Mostrar contraseña",
  ocultarSenhaAria: "Ocultar contraseña",
};
