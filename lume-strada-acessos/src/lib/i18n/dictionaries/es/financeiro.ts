...
export const financeiro: FinanceiroDict = {
  ...
  lembreteVencidasTitulo: "Cuentas vencidas",
  lembreteVencendoHojeTitulo: "Vencen hoy",
  lembreteVencidasHint: "Pasaron del vencimiento y siguen abiertas.",
  lembreteVencendoHojeHint: "Vencen hoy y aún no se pagaron.",
  lembreteVerConta: "Ver cuenta",
  lembreteFechar: "Cerrar recordatorio",
  lembreteAtrasoDias: "{n} días de atraso",
  lembreteAtrasoUmDia: "1 día de atraso",
  lembreteNadaAqui: "Nada abierto aquí — las cuentas ya deben estar pagadas.",
  ...
  editarFornecedorAria: "Editar proveedor",
  excluirFornecedorAria: "Eliminar proveedor",
  ...
  editarFornecedorTitulo: "Datos del Proveedor",
  camposOpcionaisFornecedorHint: "Completa solo lo que necesites — nada aquí es obligatorio además del nombre.",
  responsavelLabel: "Responsable",
  placeholderResponsavel: "Ej: Juan, del área financiera",
  cnpjLabel: "CUIT/RFC",
  placeholderCnpj: "00.000.000/0000-00",
  emailFornecedorLabel: "Correo electrónico",
  placeholderEmailFornecedor: "contacto@proveedor.com",
  telefoneFornecedorLabel: "Teléfono",
  placeholderTelefoneFornecedor: "(00) 00000-0000",
  enderecoFornecedorLabel: "Dirección",
  placeholderEnderecoFornecedor: "Calle, número, ciudad",
  ...
  contaOpcionalLabel: "Cuenta",
  contaEscolhidaNaBaixaHint: "Eliges la cuenta al marcar esto como pagado — evita equivocarte cuando hay más de una cuenta personal o empresarial.",
  ...
  darBaixaTitulo: "Marcar como Pagada",
  darBaixaDescricao: "¿De qué cuenta salió el pago de \"{descricao}\" ({valor})?",
  contaQuePagouLabel: "Cuenta",
  confirmarBaixaBtn: "Confirmar Pago",
  nenhumaContaParaBaixa: "No hay ninguna cuenta registrada en este contexto — registra una cuenta antes de marcar esto como pagado.",
  ...
  anexarBtn: "Adjuntar",
  anexarPorLink: "o adjunta por enlace (Drive, Dropbox…)",
  anexoNomePlaceholder: "¿De qué es este adjunto?",
  anexoLinkBadge: "enlace",
