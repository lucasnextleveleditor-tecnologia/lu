...
export const orcamentos: OrcamentosDict = {
  ...
  previewAoVivoTitulo: "Preview ao vivo — veja como pode ficar",
  ...
  previewExemploAviso: "Os blocos marcados como \"exemplo\" aqui embaixo são só uma prévia do layout — o cliente NÃO vai ver esse texto de exemplo. Pra esse trecho aparecer de verdade no link e no PDF, preencha o campo correspondente (alguns ficam aqui no orçamento, outros na aba Marca/Apresentação).",
  previewExemploTag: "exemplo — não sai pro cliente",
