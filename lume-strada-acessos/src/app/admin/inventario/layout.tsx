  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatTile icon={IconLayers} label="Categorias" value={totalCategorias ?? 0} />
        <StatTile icon={IconTag} label="Itens no Total" value={totalItens} />
        <StatTile icon={IconAlertTriangle} label="Em Manutenção" value={emManutencao} tone="warning" />
        <StatTile icon={IconPauseCircle} label="Baixados" value={baixados} tone="critical" />
      </div>
