...
// Identidade visual (preto absoluto + acento branco/zinc) é a paleta FIXA de
// cada modo — ver `.dark`/`.light` em `globals.css`. Nada é mais injetado por
// request a partir de `branding_config`; a única personalização por cliente é
// a logotipo, aplicada seletivamente em `app/admin/layout.tsx` e
// `app/dashboard/layout.tsx` (nunca aqui, nunca em `app/login/page.tsx`). O
// modo de cor (escuro/claro) é preferência PESSOAL de quem usa o painel —
// isso sim é resolvido aqui.
