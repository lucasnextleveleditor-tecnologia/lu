...
export const TONE_GLOW: Record<Tone, string> = {
  good: "shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_0_28px_-12px_rgba(12,163,12,0.5)]",
  warning: "shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_0_28px_-12px_rgba(250,178,25,0.5)]",
  critical: "shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_0_28px_-12px_rgba(211,59,59,0.45)]",
  neutral: "shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_0_28px_-12px_rgba(138,135,131,0.35)]",
};
