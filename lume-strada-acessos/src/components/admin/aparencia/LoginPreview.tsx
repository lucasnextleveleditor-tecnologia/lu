  ...
  return (
    ...
    >
      ...
      <div className="relative w-32 rounded-lg border border-base-700 bg-base-900/90 p-2.5 text-center shadow-lg">
        ...
        <p className="truncate text-[10px] font-semibold leading-tight text-ink-primary">{titulo || "Título do login"}</p>
        <p className="mt-0.5 truncate text-[8px] text-ink-muted">{subtitulo || "Subtítulo"}</p>
