  ...
  return (
    <div>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatTile icon={IconUsers} label="Total de Usuários" value={users.length} hint="Clientes + administradores" />
        <StatTile icon={IconCheckCircle} label="Ativos" value={resumo.ativo} tone="good" hint="Acesso liberado agora" />
        <StatTile icon={IconAlertTriangle} label="Expirados" value={resumo.expirado} tone="critical" hint="Precisam de renovação" />
        <StatTile icon={IconPauseCircle} label="Inativos" value={resumo.inativo} tone="neutral" hint="Suspensos manualmente" />
      </div>
