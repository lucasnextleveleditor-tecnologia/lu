    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {VISOES.map((v) => (
            <button
              ...
              className={cn(
                ...
                visao === v.value
                  ? "bg-accent text-base-950 shadow-[0_2px_10px_-2px_rgb(var(--glow-rgb) / 0.35)]"
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={() => abrirNovaTarefa()} className="shadow-[0_0_18px_-4px_rgb(var(--glow-rgb) / 0.35)]">
