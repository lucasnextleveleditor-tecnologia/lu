...
export function ProgressRing({ pct, size = 88, strokeWidth = 7, atingida = false, className }: ProgressRingProps) {
  ...
  const cor = atingida ? "#0ca30c" /* status.good */ : "#ffffff" /* accent */;
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        style={{ filter: `drop-shadow(0 0 6px ${atingida ? "rgba(12,163,12,0.65)" : "rgba(255,255,255,0.45)"})`, transition: "stroke-dashoffset 0.5s ease" }}
      />
    </svg>
  );
}
